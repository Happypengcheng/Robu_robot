...
typedef struct _PLX_PORT_PROP
{
    ...
    U32 MaxPayloadSize;              // Max payload size setting
} PLX_PORT_PROP;
...
typedef struct _PLX_DEVICE_OBJECT
{
    ...
    U64                PciBarVa[6];  // Used for PCI BAR user-mode virtual address mapping
...
typedef struct _PLX_INTERRUPT
{
    ...
    U8  Message            :1;
    U8  SwInterrupt        :1;
    U8  SecResetDeassert   :1;
    U8  SecPmeDeassert     :1;
    U8  GPIO14             :1;
    U8  GPIO4              :1;
    U32 Doorbell;
    U32 Reserved           :32;      // Reserve space for future interrupt types
} PLX_INTERRUPT;
